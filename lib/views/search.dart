  ...
  Widget searchList(){
    return searchSnapshot!= null ? ListView.builder(
      ...
      itemBuilder: (context,index){
        return SearchItem(username: searchSnapshot!.docs[0]["username"].toString(), email: searchSnapshot!.docs[0]["email"].toString(),);
      }) : Container();
  }
...
getChatRoomId(List<String> users){
  users.sort((a,b){
    print(a);
    print(b);
    return a.substring(0,1).codeUnitAt(0).compareTo(b.substring(0,1).codeUnitAt(0));
    });
  String roomId = "";
