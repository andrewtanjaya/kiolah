...
class HelperFunction {
  ...
  static Future<bool> saveUserIdSP(String userId) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(SP_ID_KEY, userId);
  }
  ...
  static Future<String?> getUserIDSP() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.getString(SP_ID_KEY);
  }
